...
#include <EEPROM.h>
//=======================КОНФИГУРАЦИЯ=======================//
#define backlight 1          //наличие подсветки 1-есть,0-нет
#define wireless 0           //наличие модуля bluetooth 1-есть,0-нет
...
const int NUM_LEDS = 6;      //это кол-во светодиодов (состоит из длины*ширину)__⌋
//==========================================================//
GButton but1(2);
GButton but2(3);
GButton but3(4);
